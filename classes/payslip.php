...
class Payslip {
	...
	public function aprovePerPost(){
		...
		$databaseObject1 = new Database(1);
		$results = $databaseObject1->PerformQuery( $query);
		
		$databaseObject2 = new Database(2);
		$results = $databaseObject2->PerformQuery( $query);
		
		$databaseObject3 = new Database(3);
		$results = $databaseObject3->PerformQuery( $query);
		
		$databaseObject4 = new Database(4);
		$results = $databaseObject4->PerformQuery( $query);
		
		$databaseObject5 = new Database(5);
		$results = $databaseObject5->PerformQuery( $query);
		
		$databaseObject6 = new Database(6);
		$results = $databaseObject6->PerformQuery( $query);
