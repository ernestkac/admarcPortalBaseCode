...
require_once 'classes\insertpayrollcodes.php';
    ...
    foreach ($payrolls as $payroll){
        ...
        if($_POST['period_input'] != ""){
            ...
            if($_POST['report_type_dropdown'] == "earnings_deductions"){
                ...
                $earningsDeductionsObj = new EarningsAndDeductions($payroll,$_POST['period_input']);
            ...
            $eventLogger->addLog($_SESSION["empid"], $_SESSION["name"],
             $_SESSION["accessLevel"], "latest fixed earnings rprt extract period");
            ...
            $eventLogger->addLog($_SESSION["empid"], $_SESSION["name"],
             $_SESSION["accessLevel"], "employee details rprt extract period");
            
            $employeeObj = new Employee($payroll);
            $employeeObj->getEmployeeDetails();
            
        } 
        else if($_POST['report_type_dropdown'] == "Sales_Report"){
            $eventLogger->addLog($_SESSION["empid"], $_SESSION["name"],
             $_SESSION["accessLevel"], "sales rprt extract period".$_POST['period_input']);
            ...
            $eventLogger->addLog($_SESSION["empid"], $_SESSION["name"],
             $_SESSION["accessLevel"], "purchases rprt extract period".$_POST['period_input']);
            
            $earningsDeductionsObj = new PurchasesReport($payroll,$_POST['fiscalyr_input']);
            
        } 
        else if($_POST['report_type_dropdown'] == "Insert_PayRoll_Codes" && $_POST['payroll_code']  !="" && $_POST['empid_input']  !=""){
            $Employees = $_POST['empid_input'];
            $EarnDed = "";
            ...
            $Employees = str_replace(")","",$Employees);
            //var_dump($EarnDed);
            $earningsDeductionsObj = new InsertPayRollCodes($payroll,$Employees,$_POST['payroll_code'],$EarnDed);
            ...
            //var_dump($Employees);
            $addEarningsDeductionsObj = new AddEarningOrDeduction($payroll,$Employees,$_POST['payroll_code'],$EarnDed);
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    if($_SESSION["accessLevel"] == 'ADMIN'){
                                        echo '<option value="Insert_PayRoll_Codes">Insert PayRoll Codes</option>';
