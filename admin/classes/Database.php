...
class Database {
	...
	function __construct($databaseNumber){
		...
		//var_dump($this->databaseNumber);
		$this->databaseName = Database::databases[$this->databaseNumber];
		$this->GetConnection();
	}
	...
	public function __destruct(){
		...
		//echo "database destructor called with ".$this->databaseNumber;
	}
